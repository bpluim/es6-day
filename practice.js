...
const objects = destructuring.objects;

const arrays = destructuring.arrays;
...
const notVar = vocabAgain[0];

const alsoNotVar = vocabAgain[1];

const everythingElse = vocabAgain.splice(2);
